...
export default function About() {
  return (
    <section className="bg-black relative py-32 md:py-24 overflow-hidden">
      {/* Background Ambience */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16 md:mb-24">
          <motion.h2
            ...
            className="text-6xl md:text-8xl font-thin text-white tracking-tighter mb-8"
          >
            Three paths <br />
            <span className="font-semibold bg-gradient-to-b from-white to-white/50 bg-clip-text text-transparent">
              to progress
            </span>
          </motion.h2>
          <motion.p
            ...
            className="text-gray-400 text-lg md:text-2xl font-light max-w-2xl mx-auto"
          >
        ...
        <div className="relative flex flex-col items-center justify-center min-h-[400px] sm:min-h-[500px] md:min-h-[900px]">
          ...
          <div className="w-full h-full absolute inset-0 hidden md:block pointer-events-none">
            {/* CARD 1: Creative Clarity (The White Glass Card) */}
            <motion.div
            ...
            >
              ...
              <div
                className="bg-white/90 backdrop-blur-xl p-8 shadow-[0_20px_50px_rgba(255,255,255,0.1)] transition-transform duration-300 hover:-translate-y-2"
                style={{
            ...
            {/* CARD 2: Technical Precision (Dark Tech Card) */}
            <motion.div
              initial={{ opacity: 0, x: -100, y: 50 }}
              whileInView={{ opacity: 1, x: 0, y: 0 }}
            ...
            >
              ...
              <div className="bg-[#0f0f0f]/80 backdrop-blur-md border border-white/10 p-8 rounded-2xl hover:border-cyan-500/30 transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_0_30px_rgba(34,211,238,0.1)]">
            ...
            {/* CARD 3: Strategic Thinking (Dark Purple Accent) */}
            <motion.div
              initial={{ opacity: 0, x: 100, y: 50 }}
              whileInView={{ opacity: 1, x: 0, y: 0 }}
            ...
            >
              ...
              <div className="bg-[#0f0f0f]/80 backdrop-blur-md border border-white/10 p-8 rounded-2xl hover:border-purple-500/30 transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_0_30px_rgba(168,85,247,0.1)]">
          ...
          <div className="flex flex-col gap-4 mt-8 md:hidden w-full max-w-sm mx-auto px-4">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-white text-black p-6 relative shadow-lg"
              style={{
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-[#1a1a1a] border border-white/10 text-white p-6 rounded-xl"
            >
